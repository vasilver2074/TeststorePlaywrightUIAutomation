...
export class ProductDetailsPage extends BasePage {
  ...
  readonly locators: ProductDetailsPageLocators =
    new ProductDetailsPageLocators(this.page.locator("#wrapper"));

  readonly locators1: ProductDetailsPageLocators =
    new ProductDetailsPageLocators(this.page.locator(".modal-content"));
  ...
  async proceedToCheckout(): Promise<void> {
    await this.locators1.proceedToCheckoutButtonLocator.waitFor({
      timeout: 3000,
    });
